package org.rvalenzuela.pooherencia;
...
public class Alumno extends Persona{
    ...
    public Alumno() {
        System.out.println("Alumno: innicializando contructor");
    }
    ...
    public Alumno(String nombre, String apellido, int edad,
                  String institucion, double notaMatematica, double notaHistoria, double notaCastellano){
